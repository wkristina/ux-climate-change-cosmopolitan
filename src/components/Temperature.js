...
class Temperature extends Component {
  ...
  <div class="column">
    ...
    <ScatterChart width={700} height={400} margin={{top: 20, right: 20, bottom: 20, left: 20}} className="graphBox">
<CartesianGrid />
<Tooltip/>
<XAxis dataKey={"Year"}/>
<YAxis dataKey={"Mean"} />
<Scatter name='Mean' data={temperature}  fill='#ff0080'/>
</ScatterChart>
      </div>
  </div>
  ...
  <div class="column"></div>
  <div class="column">
      <p className="description">Average global mean temperature anomalies in degrees Celsius</p>
      <br />
  <CompareBoxes
