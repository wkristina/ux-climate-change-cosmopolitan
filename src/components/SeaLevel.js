    ...
    <div class="seven wide column">
      <div className="two column grid">
        <div className="row">
          ...
          <br/>
          <p><span style={{color:"#FF008B"}}>10.46 million tons of clothing</span> ended up in US landfills in 2014.</p>
          </div>
